...
# ==========================================================================
    ...
    cmd.motor_cmd[14].kp = 280.0   # Жесткость
...
# Левая рука - ОПУЩЕНА по шву
    ...
    cmd.motor_cmd[15].kp = 160.0   # Жесткость
